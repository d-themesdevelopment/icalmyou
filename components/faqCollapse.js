        ...
        >
          ...
          <span className="icon-up active rounded-2xl w-[46px] h-[46px] flex justify-center items-center shrink-0">
            {!open && (
              ...
              >
                <path
                  d="M14.0029 20.6416L6.03418 12.6729C5.4834 12.1221 5.4834 11.2314 6.03418 10.6865L7.3584 9.3623C7.90918 8.81152 8.7998 8.81152 9.34473 9.3623L14.9932 15.0107L20.6416 9.3623C21.1924 8.81152 22.083 8.81152 22.6279 9.3623L23.9521 10.6865C24.5029 11.2373 24.5029 12.1279 23.9521 12.6729L15.9834 20.6416C15.4443 21.1924 14.5537 21.1924 14.0029 20.6416Z"
                  fill="#A05956"
                />
              </svg>
            )}
